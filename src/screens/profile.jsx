...
const Profile = () => {
  ...
  return (
    <ImageBackground source={b} style={styles.container}>
        <Image source={photo} style={{width:100,height:100,marginBottom:100,borderRadius:50}}></Image>
        <Text style={{fontSize:15,fontWeight:'bold',color:'black',backgroundColor: 'rgba(255, 255, 255, 0.6)',borderRadius:12,padding:20,width:'70%',height:5, textAlign: 'center',marginBottom:30}}>{email}</Text>
